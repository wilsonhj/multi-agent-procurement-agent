...
>
> `docs/current-state.md` carries the same now-false claim in two places (its AC-8 row, and its
> good-first-contribution list). It is outside this change's file boundary and is flagged here for
> its owner.
